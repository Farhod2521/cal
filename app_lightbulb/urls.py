...
from .views import Type_of_premises_ListApiview, LampCalculationAPIView, RoomTypeCategoryListView, RoomTypeListView, RoomTypeCategoryByParentView, RoomTypeCategoryAPIView
